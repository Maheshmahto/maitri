...
<div className="absolute top-20 left-36 flex flex-col items-start justify-center ">
        <h1 className={`text-black lg:text-4xl 2xl:text-4xl font-semibold mb-10 tracking-[0.15em] ${montserrat.className}`}>2012</h1>
        <h1 className={`text-[#7A7161] lg:text-4xl 2xl:text-5xl font-medium ${cormorant.className}`}>
          The Enquiry  <span className="italic font-semibold">Begins</span>
        </h1>
        <p
...
>
  ...
  conviction that there had to be a better way.
      ...
      <div className="absolute top-[26%] right-[12%] max-w-xl">
  ...
  The moment when science became artistry.
      ...
      <div className="absolute top-[45%] left-[8%] max-w-xl">
        ...
        <h2 className={`text-[#7A7161] text-4xl mb-4 font-medium ${cormorant.className}`}>
          Rare <span className="italic font-semibold">Beauty</span>
        </h2>
      ...
      <div className="absolute top-[65%] right-[8%] max-w-xl">
        ...
        <h2 className={`text-[#8B7969] text-5xl mb-4 font-medium ${cormorant.className}`}>
...
>
  ...
  uncompromising standards, deserved equal reverence.
      ...
      <div className="absolute top-[85%] left-[8%] max-w-2xl">
        <h1 className={`text-black lg:text-4xl 2xl:text-4xl font-semibold mb-10 tracking-[0.15em] ${montserrat.className}`}>2025</h1>
        <h2 className={`text-[#7A7161] text-5xl mb-4 font-medium ${cormorant.className}`}>
          Where Science <span className="italic font-semibold">Meets Artistry</span>
        </h2>
        <p
  className={`text-[#8B7969] text-base font-normal  leading-[28px]  tracking-[0.02em]  max-w-[700px]  text-justify  whitespace-normal break-words
 ${montserrat.className}`}
>
